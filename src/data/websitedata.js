...
//   ],
//   hero: {
//     title: "Unlock Growth with Proven Business Solutions",
//     subtitle: "Unlock potential with tailored strategies designed for success.",
//     cta: {
//       primary: "Get Started",
...
//     {
//       title: "Bedroom",
//       images: ["/images/bedroom.jpg", "/images/bedroom.jpg"]
//     },
//     {
//       title: "Living Room",
...
//     {
//       title: "Renovation",
//       images: ["/images/reno.jpg", "/images/reno.jpg"]
//     }
//   ],
//   gallery: [
//     {
...
//     ],
//     about: "We design homes, shops, restaurants, and modern spaces with premium interior solutions.",
...
//       subtitle: "Explore our finest interior projects crafted with precision, creativity, and a modern aesthetic."
//     },
//     testimonials: {
//       title: "Trusted by 30+ world class companies & design teams"
//     },
//     team: {
//       title: "Our Team",
//       subtitle: "A visual collection of our most recent works - each piece crafted with intention, emotion and style."
//     },
//     contactInfo: {
//       title: "Office Near You."
//     },
//     services: {
//       title: "Our Services",
//       subtitle: "We deliver modern, scalable and high-performance solutions designed for real-world products and real users."
//     },
//     cta: {
//       tag: "✨ Transform Your Space",
//       title: "Ready to Design Your Dream Space?",
//       subtitle: "From modern homes to luxury commercial interiors, we turn your vision into reality with creativity, precision, and elegance.",
//       buttons: {
...
export const websiteData = {
  ...
  hero: {
    ...
    subtitle: "We design modern, stylish, and functional interiors for homes, offices, and commercial spaces.",
    cta: {
      primary: "Get Free Consultation",
  ...
  services: [
    {
      ...
      description: "Beautiful home interiors designed to match your lifestyle, comfort, and personality.",
      hasAccent: false
    },
    {
      icon: "FiMonitor",
      title: "Commercial Spaces",
      description: "Smart and modern interiors for offices, shops, and business environments.",
      hasAccent: true
    },
    {
      icon: "FiGlobe",
      title: "Restaurant & Café Design",
      description: "Stylish dining spaces with premium ambiance and efficient layouts.",
      hasAccent: false
    },
    {
      icon: "FiLayers",
      title: "Custom Furniture",
      description: "High-quality furniture tailored to your space and design theme.",
      hasAccent: false
    },
    {
      icon: "FiRefreshCw",
      title: "Renovation & Remodeling",
      description: "Upgrade your old interiors into modern, elegant, and functional spaces.",
      hasAccent: false
    },
    {
      icon: "FiZap",
      title: "Space Planning",
      description: "Efficient layouts that maximize space utilization and aesthetics.",
      hasAccent: false
    },
    {
      icon: "FiTool",
      title: "Turnkey Solutions",
      description: "Complete interior solutions from design to execution under one roof.",
      hasAccent: false
    },
    {
      icon: "FiCode",
      title: "3D Visualization",
      description: "Realistic 3D designs to help you visualize your dream space before execution.",
      hasAccent: false
    }
  ],
  ...
  sections: {
    ourWork: {
      title: "Our Latest Work",
      subtitle: "Explore our recent interior projects crafted with creativity, elegance, and attention to detail.",
      projectsTitle: "Our Latest Projects",
      stats: "total project images"
    },
    gallery: {
      title: "Our Creative Gallery",
      subtitle: "Explore our finest interior designs created with precision and modern aesthetics."
    },
    testimonials: {
    ...
    services: {
      title: "Our Services",
      subtitle: "Complete interior design solutions for homes, offices, and commercial spaces."
    },
    cta: {
      tag: "✨ Transform Your Space",
      title: "Ready to Design Your Dream Space?",
      subtitle: "We turn your ideas into reality with modern, elegant, and functional interiors.",
      buttons: {
        primary: "Get Free Consultation",
        secondary: "View Our Work"
      }
